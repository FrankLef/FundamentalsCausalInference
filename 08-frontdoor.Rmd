...
#   sim1_df, fciR::frontdr_np, times = 100, alpha = 0.05, inv = "none", 
#   formula = Y ~ A + S, exposure.name = "A")
# endTime <- Sys.time()
# print(endTime - startTime)
a_file <- file.path(dir_data, "chap08_sim1_np.rds")
# saveRDS(sim1.np, file = a_file)
sim1.np <- readRDS(file = a_file)
```
