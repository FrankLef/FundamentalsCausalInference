...
```{r echo=FALSE, fig.align='center', fig.cap="Example of a Directed Acyclic Graph", warning=FALSE, out.width="60%"}
scm_5.1$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="Causal DAG With Collider", warning=FALSE, out.width="60%"}
scm_5.3$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="Causal DAG With Intermediate Variable", warning=FALSE, out.width="60%"}
scm_5.4$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="Confounder May Occur After the Exposure", out.width="80%"}
scm_5.5$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="One way to generate confounding", warning=FALSE, out.width="80%"}
scm_5.6$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="Another way to generate confounding", warning=FALSE, out.width="60%"}
scm_5.7$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="Potential Outcomes Behind the Scenes", warning=FALSE, out.width="80%"}
scm_5.8$plot
```
...
```{r echo=FALSE, fig.align='center', fig.cap="The Double What-If? Study", warning=FALSE, out.width="80%"}
scm_5.9$plot
```
...
scm_ex5.5 <- within(scm_ex5.5, {
  ...
  # format the tableau
  summ <- gt_probs(tbl, title = "Table exercise 5.5",
