...
```{r fig.cap="Figure 5.1", fig.align='center', warning=FALSE, out.width="60%"}
# Source:
...
scm$plot
knitr::write_bib(c("simstudy"), width = 80)
```
...
```{r fig.cap="Figure 5.3", fig.align='center', warning=FALSE, out.width="60%"}
scm_5.3 <- list()
...
```{r fig.cap="Figure 5.4", fig.align='center', warning=FALSE, out.width="60%"}
scm_5.4 <- list()
...
```{r fig.cap="Figure 5.5", fig.align='center', warning=FALSE, out.width="60%"}
scm_5.5 <- list()
...
```{r fig.cap="Figure 5.6", fig.align='center', warning=FALSE, out.width="60%"}
scm_5.6 <- list()
...
for th works that follows the tables will be formatted with this function
...
```{r fig.cap="Figure 5.7", fig.align='center', warning=FALSE, out.width="60%"}
scm_5.7 <- list()
...
```{r fig.cap="Figure 5.8", fig.align='center', warning=FALSE, out.width="60%"}
scm_5.8 <- list()
