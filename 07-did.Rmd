...
#        local = knitr::knit_global())
# source(file = file.path(dir_lib, "gt_measures_rowgrp.R"), 
#        local = knitr::knit_global())
# source(file = file.path(dir_lib, "fci_07-A_didlinear.R"), 
#        local = knitr::knit_global())
# source(file = file.path(dir_lib, "fci_07-B_didloglinear.R"), 
#        local = knitr::knit_global())
# source(file = file.path(dir_lib, "fci_07-C_didlogistic.R"), 
#        local = knitr::knit_global())
