...
```{r}
dwhatif.lindid <- fciR::did_linear(doublewhatifdat, outcomes = c("VL0", "VL1"), 
                                   outcome = "Y", treatment = "A", R = 100)
# dwhatif.lindid
```
...
```{r}
dwhatif.loglindid <- fciR::did_loglinear(doublewhatifdat, outcomes = c("VL0", "VL1"), 
                                   outcome = "Y", treatment = "A", R = 100)
# dwhatif.loglindid
```
...
```{r}
dwhatif.logisticdid <- fciR::did_logistic(doublewhatifdat, outcomes = c("VL0", "VL1"), 
                                   outcome = "Y", treatment = "A", R = 100)
# dwhatif.logisticdid
```
