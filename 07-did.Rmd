...
#   doublewhatifdat, fciR::did_linear, times = 100, alpha = 0.05, 
#   formula = VL1 ~ A + VL0, exposure.name = "A")
# endTime <- Sys.time()
# print(endTime - startTime)
a_file <- file.path(dir_data, "chap07_dwhatif_did_lin.rds")
# saveRDS(dwhatif.did.lin, file = a_file)
dwhatif.did.lin <- readRDS(file = a_file)
```
...
#   doublewhatifdat, fciR::did_loglinear, times = 100, alpha = 0.05, 
#   formula = VL1 ~ A + VL0, exposure.name = "A")
# endTime <- Sys.time()
# print(endTime - startTime)
a_file <- file.path(dir_data, "chap07_dwhatif_did_loglin.rds")
# saveRDS(dwhatif.did.loglin, file = a_file)
dwhatif.did.loglin <- readRDS(file = a_file)
```
...
#   doublewhatifdat, fciR::did_logistic, times = 100, alpha = 0.05, 
#   formula = VL1 ~ A + VL0, exposure.name = "A")
# endTime <- Sys.time()
# print(endTime - startTime)
a_file <- file.path(dir_data, "chap07_dwhatif_did_logit.rds")
# saveRDS(dwhatif.did.logit, file = a_file)
dwhatif.did.logit <- readRDS(file = a_file)
```
