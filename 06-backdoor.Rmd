...
```{r echo=FALSE, file="lib\\fci_06-A_stand.R"}
...
```{r echo=FALSE, file="lib\\fci_06-B_standout.R"}
...
The function `standexp` used to standardized with a parametric exposure
model
...
gt_measures(whatif2.exp, 
            title = "Table 6.9", 
            subtitle = "What-If Study<br>Exposure-model Standardization <em>with H = lvlcont0</em>")
```
