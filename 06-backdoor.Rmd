...
tbl <- fciR::gt_measures(mort.out.npr,  digits = 6,
            title = "Mortality", 
            subtitle = paste("Mortality", 
                              "Standardized Estimates",
                              "Non Parametric With Regression",
                              sep = "<br>"))
p <- fciR::ggp_measures(mort.out.npr,
                   title = "Mortality Data Effect Measures",
                   ...
                   title_size = 0.9, text_y_size = 0.9)
tbl <- fciR::gt2ggp(tbl)
p + tbl
```
