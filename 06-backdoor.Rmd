...
source(file = file.path(dir_lib, "gt_measures.R"), 
       local = knitr::knit_global())
source(file = file.path(dir_lib, "calc_exposure.R"), 
       local = knitr::knit_global())
...
Compute the standardized estimates using exposure modeling. The author puts
it with the data itself.  We separate the data from the logic and faciliate
code reuse and readability.

```{r echo=TRUE, file="lib\\calc_exposure.R"}
