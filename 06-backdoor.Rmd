...
fciR::gt_measures(mort.out.np,  digits = 6,
            ...
            subtitle = paste("Mortality", 
                              "Standardized Estimates via Outcome Modeling",
...
tbl <- fciR::gt_measures(df,  digits = 6,
            ...
            subtitle = paste("Mortality", 
                              ...
                              sep = "<br>"))
p <- ggp_format(df, type = "measures_tbl")
p <- do.call(what = fciR::ggp_measures, args = p)
...
tbl <- fciR::gt_measures(df, 
            title = "Table 6.7", 
            subtitle = paste("What-If Study", 
                             "Outcome-model Standardization with <em>H = lvlcont0</ems>",
                             sep = "<br>"))
p <- fciR::ggp_measures(df,
                   title = NULL,
                   subtitle = NULL)
