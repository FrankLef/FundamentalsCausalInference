...
The standard error formula used is with the standard deviaiton of the population
and equivalent to 
...
when the correct definition is with the standard deviaiton of the sample
...
The p-value found using a chi-square test is 3.207e-11. Using a t-test of the
mean difference gives a p-value of 2.269e-9. It is not explained how the p-value
of 0.032 is arrived at in the book.
...
Based on the notation of mentioned in the second paragraph of p. 158, that 
we let $Y(t,a)$ be the potential outcome of $Y$ assuming we set $T=t$ and then 
$A=a$. Then the equation could be written more simply as
